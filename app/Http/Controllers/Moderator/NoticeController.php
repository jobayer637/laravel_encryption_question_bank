...
class NoticeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('moderator.notice.create', compact('notices'));
    }
    ...
    {
        $notices = Notice::latest()->take(10)->get();
        return view('moderator.notice.show', compact('notice', 'notices'));
    }
    ...
    {
        $notices = Notice::latest()->take(10)->get();
        return view('moderator.notice.edit', compact('notice', 'notices'));
    }
