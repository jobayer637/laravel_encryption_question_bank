...
@endphp
   <div class="row">
       <div class="col-md-6">
            ...
            <div class="card">
                <form action="{{ route('moderator.profile.update', $user->id) }}" method="post" enctype="multipart/form-data">
       ...
       <div class="col-md-6">
           <div class="card">
                ...
                <div class="card-body">
                    <form id="" action="{{ route('moderator.profile.update', $user->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
